    ...
    <header className="sticky top-0 z-40 border-b rule-gold bg-ivory/85 backdrop-blur">
      <Container className="flex h-20 items-center justify-between gap-3">
        ...
        <Link href="/" className="flex items-center gap-3.5" aria-label={`${site.name} — accueil`}>
          <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border-2 border-gold text-prune font-serif text-xl font-semibold">
            N
          </span>
          <span className="hidden font-serif text-xl font-semibold tracking-wide text-prune sm:inline-block">
            NARREA STUDIO
          </span>
        </Link>
